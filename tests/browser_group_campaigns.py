    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        def page():
            ...
            return ('<!doctype html><html><head><meta name="viewport" content="width=device-width, initial-scale=1">'
                    + styles + '</head><body><a href="#" class="menu-item" data-tab="comingSoon">Tarefas de grupos</a><main class="main-content">'
        ...
        try:
            with sync_playwright() as playwright:
                ...
                page.locator('#campaign-sessions').select_option('test.session')
                ...
                page.locator('#campaign-list h3').wait_for()
                ...
                page.wait_for_function('document.getElementById("campaign-lead-total").textContent.includes("1 leads")')
